...
def generate(root,output_dir):
    ...
    report={"report":"TC_05_DETERMINISTIC_DISPATCH_INTEGRATION_REPORT","status":"IMPLEMENTED_CANDIDATE" if accepted else "FAILED",
      ...
      "branch":"implementation/tc-05-deterministic-dispatch","implementation_commit":"PENDING_AT_GENERATION","final_evidence_commit":"PENDING_AT_GENERATION",
      ...
      "tc01_regression":"PENDING","tc02_regression":"PENDING","tc03_regression":"PENDING","tc04_regression":"PENDING",
      "new_llm_calls_for_tc05_testing":0,"protected_scope_changed":"NO","slice002_historical_evidence_changed":"NO",
      "groq_executed":"NO","a4_executed":"NO","a5_executed":"NO","zero_cost_only":"PASS","tests":"PENDING","security_check":"PENDING",
